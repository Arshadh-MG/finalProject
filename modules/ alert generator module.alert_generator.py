...
class AlertGenerator:
    ...
    def _check_duplicate(self, camera_id):
        ...
        Returns:
            True if duplicate alert should be prevented
        """
...
# Standalone function for quick alert generation
def create_alert(input_mode, camera_id, animal_class, yolo_confidence, 
                injury_probability, bbox, evidence_path=None):
    """
    Standalone function to create an alert
    
    Returns:
        Alert dictionary
    """
    generator = AlertGenerator()
    return generator.generate_alert(
        input_mode=input_mode,
        camera_id=camera_id,
        animal_class=animal_class,
